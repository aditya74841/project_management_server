...
export const createProject = asyncHandler(async (req, res) => {
  const { name, description, companyId, deadline, members = [] } = req.body;

  const existingProject = await Project.findOne({ name, companyId });
  if (existingProject) {
    throw new ApiError(409, "A project with this name already exists in the company");
  }
...
export const getProjectById = asyncHandler(async (req, res) => {
  ...
  export const deleteProject = asyncHandler(async (req, res) => {
    ...
    if (String(project.createdBy) !== String(req.user._id) && req.user.role !== "superAdmin") {
  ...
  export const toggleProjectVisibility = asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { isShown: project.isShown }, "Project visibility toggled"));
  });
  ...
  export const addMemberToProject = asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { members: project.members }, "Member added successfully"));
  });
  ...
  export const removeMemberFromProject = asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { members: project.members }, "Member removed successfully"));
  });
  ...
  export const assignFeatureToProject = asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { features: project.features }, "Feature assigned successfully"));
  });
  ...
  export const unassignFeatureFromProject = asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { features: project.features }, "Feature unassigned successfully"));
  });
